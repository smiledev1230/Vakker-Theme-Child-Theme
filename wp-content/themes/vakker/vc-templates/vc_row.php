...
if($row_content_width === 'grid'){
	$eltd_row_wrapper_start .= '<div class="eltd-row-grid-section-wrapper '.esc_attr($grid_row_classes).'" '.esc_attr($grid_row_datas).' ' . vakker_eltd_get_inline_style( $eltd_grid_row_styles ) . '><div class="eltd-row-grid-section">';
