...
$eltd_rev_style = array();

if ( $enable_paspartu === 'yes' ) {
	$css_class .= ' eltd-rev-has-paspartu';
	
	if ( ! empty( $paspartu_size ) ) {
		$css_class .= ' eltd-paspartu-' . $paspartu_size;
	}
	
	if ( $disable_side_paspartu === 'yes' ) {
		$css_class .= ' eltd-side-paspartu-disabled';
	}
	
	if ( $disable_top_paspartu === 'yes' ) {
		$css_class .= ' eltd-top-paspartu-disabled';
	}
}
