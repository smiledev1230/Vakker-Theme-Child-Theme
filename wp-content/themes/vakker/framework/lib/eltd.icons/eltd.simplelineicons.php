...
class VakkerElatedSimpleLineIcons implements iVakkerElatedIconCollection {
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'vakker'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'vakker'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'vakker'),
            'icon-social-facebook'    => esc_html__('Facebook', 'vakker'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'vakker'),
            'icon-social-github'      => esc_html__('Github', 'vakker'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'vakker'),
            'icon-social-instagram'   => esc_html__('Instagram', 'vakker'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'vakker'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'vakker'),
            'icon-social-reddit'      => esc_html__('Reddit', 'vakker'),
            'icon-social-skype'       => esc_html__('Skype', 'vakker'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'vakker'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'vakker'),
            'icon-social-spotify'     => esc_html__('Spotify', 'vakker'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'vakker'),
            'icon-social-twitter'     => esc_html__('Twitter', 'vakker'),
            'icon-social-youtube'     => esc_html__('Youtube', 'vakker')
        );
    }
