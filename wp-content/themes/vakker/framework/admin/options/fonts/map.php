...
if ( ! function_exists( 'vakker_eltd_fonts_options_map' ) ) {
	/**
	 * Font options page
	 */
	function vakker_eltd_fonts_options_map() {
		
		vakker_eltd_add_admin_page(
			array(
				'slug'  => '_fonts_page',
				'title' => esc_html__( 'Fonts', 'vakker' ),
				'icon'  => 'fa fa-font'
			)
		);
		 ...
		 * Headings
		 */
		$panel_headings = vakker_eltd_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_headings',
				'title' => esc_html__( 'Headings', 'vakker' )
			)
		);
		
		//H1
		$group_heading_h1 = vakker_eltd_add_admin_group(
			array(
				'name'        => 'group_heading_h1',
				'title'       => esc_html__( 'H1 Style', 'vakker' ),
				'description' => esc_html__( 'Define styles for h1 heading', 'vakker' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h1_1 = vakker_eltd_add_admin_row(
			array(
		...
		vakker_eltd_add_admin_field(
			array(
				...
				'args'          => array(
					'suffix' => esc_html__( 'px / em', 'vakker' )
				),
				'parent'        => $row_heading_h1_1
			)
		);
		...
		$row_heading_h1_2 = vakker_eltd_add_admin_row(
			array(
		...
		$row_heading_h1_3 = vakker_eltd_add_admin_row(
			array(
		...
		vakker_eltd_add_admin_field(
			array(
				...
				'name'          => 'h1_margin_top',
				'default_value' => '',
				'label'         => esc_html__( 'Margin Top', 'vakker' ),
		...
		vakker_eltd_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Bottom', 'vakker' ),
				'parent'        => $row_heading_h1_3
			)
		);
		
		//H2
		$group_heading_h2 = vakker_eltd_add_admin_group(
			array(
				'name'        => 'group_heading_h2',
				'title'       => esc_html__( 'H2 Style', 'vakker' ),
				'description' => esc_html__( 'Define styles for h2 heading', 'vakker' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h2_1 = vakker_eltd_add_admin_row(
			array(
		...
		$row_heading_h2_2 = vakker_eltd_add_admin_row(
			array(
		...
		$row_heading_h2_3 = vakker_eltd_add_admin_row(
			array(
		...
		//H3
		$group_heading_h3 = vakker_eltd_add_admin_group(
			array(
				'name'        => 'group_heading_h3',
				'title'       => esc_html__( 'H3 Style', 'vakker' ),
				'description' => esc_html__( 'Define styles for h3 heading', 'vakker' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h3_1 = vakker_eltd_add_admin_row(
			array(
		...
		$row_heading_h3_2 = vakker_eltd_add_admin_row(
			array(
		...
		$row_heading_h3_3 = vakker_eltd_add_admin_row(
			array(
		...
		//H4
		$group_heading_h4 = vakker_eltd_add_admin_group(
			array(
				'name'        => 'group_heading_h4',
				'title'       => esc_html__( 'H4 Style', 'vakker' ),
				'description' => esc_html__( 'Define styles for h4 heading', 'vakker' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h4_1 = vakker_eltd_add_admin_row(
			array(
		...
		$row_heading_h4_2 = vakker_eltd_add_admin_row(
			array(
		...
		$row_heading_h4_3 = vakker_eltd_add_admin_row(
			array(
		...
		//H5
		$group_heading_h5 = vakker_eltd_add_admin_group(
			array(
				'name'        => 'group_heading_h5',
				'title'       => esc_html__( 'H5 Style', 'vakker' ),
				'description' => esc_html__( 'Define styles for h5 heading', 'vakker' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h5_1 = vakker_eltd_add_admin_row(
			array(
		...
		$row_heading_h5_2 = vakker_eltd_add_admin_row(
			array(
		...
		$row_heading_h5_3 = vakker_eltd_add_admin_row(
			array(
		...
		//H6
		$group_heading_h6 = vakker_eltd_add_admin_group(
			array(
				'name'        => 'group_heading_h6',
				'title'       => esc_html__( 'H6 Style', 'vakker' ),
				'description' => esc_html__( 'Define styles for h6 heading', 'vakker' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h6_1 = vakker_eltd_add_admin_row(
			array(
		...
		$row_heading_h6_2 = vakker_eltd_add_admin_row(
			array(
		...
		$row_heading_h6_3 = vakker_eltd_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings3 = vakker_eltd_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings3',
				'title' => esc_html__( 'Headings Responsive (Tablet Landscape View)', 'vakker' )
			)
		);
		
		//H1
		$group_responsive3_heading_h1 = vakker_eltd_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h1',
				'title'       => esc_html__( 'H1 Responsive Style', 'vakker' ),
				'description' => esc_html__( 'Define responsive styles for h1 heading', 'vakker' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h1_3 = vakker_eltd_add_admin_row(
			array(
		...
		//H2
		$group_responsive3_heading_h2 = vakker_eltd_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h2',
				'title'       => esc_html__( 'H2 Responsive Style', 'vakker' ),
				'description' => esc_html__( 'Define responsive styles for h2 heading', 'vakker' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h2_3 = vakker_eltd_add_admin_row(
			array(
		...
		//H3
		$group_responsive3_heading_h3 = vakker_eltd_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h3',
				'title'       => esc_html__( 'H3 Responsive Style', 'vakker' ),
				'description' => esc_html__( 'Define responsive styles for h3 heading', 'vakker' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h3_3 = vakker_eltd_add_admin_row(
			array(
		...
		//H4
		$group_responsive3_heading_h4 = vakker_eltd_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h4',
				'title'       => esc_html__( 'H4 Responsive Style', 'vakker' ),
				'description' => esc_html__( 'Define responsive styles for h4 heading', 'vakker' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h4_3 = vakker_eltd_add_admin_row(
			array(
		...
		//H5
		$group_responsive3_heading_h5 = vakker_eltd_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h5',
				'title'       => esc_html__( 'H5 Responsive Style', 'vakker' ),
				'description' => esc_html__( 'Define responsive styles for h5 heading', 'vakker' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h5_3 = vakker_eltd_add_admin_row(
			array(
		...
		//H6
		$group_responsive3_heading_h6 = vakker_eltd_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h6',
				'title'       => esc_html__( 'H6 Responsive Style', 'vakker' ),
				'description' => esc_html__( 'Define responsive styles for h6 heading', 'vakker' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h6_3 = vakker_eltd_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings = vakker_eltd_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings',
				'title' => esc_html__( 'Headings Responsive (Tablet Portrait View)', 'vakker' )
			)
		);
		
		//H1
		$group_responsive_heading_h1 = vakker_eltd_add_admin_group(
			array(
		...
		$row_responsive_heading_h1_1 = vakker_eltd_add_admin_row(
			array(
		...
		//H2
		$group_responsive_heading_h2 = vakker_eltd_add_admin_group(
			array(
		...
		$row_responsive_heading_h2_1 = vakker_eltd_add_admin_row(
			array(
		...
		//H3
		$group_responsive_heading_h3 = vakker_eltd_add_admin_group(
			array(
		...
		$row_responsive_heading_h3_1 = vakker_eltd_add_admin_row(
			array(
		...
		//H4
		$group_responsive_heading_h4 = vakker_eltd_add_admin_group(
			array(
		...
		$row_responsive_heading_h4_1 = vakker_eltd_add_admin_row(
			array(
		...
		//H5
		$group_responsive_heading_h5 = vakker_eltd_add_admin_group(
			array(
		...
		$row_responsive_heading_h5_1 = vakker_eltd_add_admin_row(
			array(
		...
		//H6
		$group_responsive_heading_h6 = vakker_eltd_add_admin_group(
			array(
		...
		$row_responsive_heading_h6_1 = vakker_eltd_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings2 = vakker_eltd_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings2',
				'title' => esc_html__( 'Headings Responsive (Mobile Devices)', 'vakker' )
			)
		);
		
		//H1
		$group_responsive2_heading_h1 = vakker_eltd_add_admin_group(
			array(
		...
		$row_responsive2_heading_h1_1 = vakker_eltd_add_admin_row(
			array(
		...
		//H2
		$group_responsive2_heading_h2 = vakker_eltd_add_admin_group(
			array(
		...
		$row_responsive2_heading_h2_1 = vakker_eltd_add_admin_row(
			array(
		...
		//H3
		$group_responsive2_heading_h3 = vakker_eltd_add_admin_group(
			array(
		...
		$row_responsive2_heading_h3_1 = vakker_eltd_add_admin_row(
			array(
		...
		//H4
		$group_responsive2_heading_h4 = vakker_eltd_add_admin_group(
			array(
		...
		$row_responsive2_heading_h4_1 = vakker_eltd_add_admin_row(
			array(
		...
		//H5
		$group_responsive2_heading_h5 = vakker_eltd_add_admin_group(
			array(
		...
		$row_responsive2_heading_h5_1 = vakker_eltd_add_admin_row(
			array(
		...
		//H6
		$group_responsive2_heading_h6 = vakker_eltd_add_admin_group(
			array(
		...
		$row_responsive2_heading_h6_1 = vakker_eltd_add_admin_row(
			array(
		 ...
		 * Text
		 */
		$panel_text = vakker_eltd_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_text',
		...
		$group_text = vakker_eltd_add_admin_group(
			array(
				'name'        => 'group_text',
				'title'       => esc_html__( 'Paragraph', 'vakker' ),
				'description' => esc_html__( 'Define styles for paragraph text', 'vakker' ),
				'parent'      => $panel_text
			)
		);
		
		$row_text_1 = vakker_eltd_add_admin_row(
			array(
				'name'   => 'row_text_1',
				'parent' => $group_text
			)
		...
		$row_text_2 = vakker_eltd_add_admin_row(
			array(
				'name'   => 'row_text_2',
				'parent' => $group_text,
				'next'   => true
		...
		$group_text_res1 = vakker_eltd_add_admin_group(
			array(
				'name'        => 'group_text_res1',
				'title'       => esc_html__( 'Paragraph Responsive (Table Portrait View)', 'vakker' ),
				'description' => esc_html__( 'Define responsive styles for paragraph text for table devices - portrait view', 'vakker' ),
				'parent'      => $panel_text
			)
		);
		
		$row_res_text_1 = vakker_eltd_add_admin_row(
			array(
				'name'   => 'row_text_1',
		...
		$group_text_res2 = vakker_eltd_add_admin_group(
			array(
				'name'        => 'group_text_res2',
				'title'       => esc_html__( 'Paragraph Responsive (Mobile Devices)', 'vakker' ),
				'description' => esc_html__( 'Define responsive styles for paragraph text for mobile devices', 'vakker' ),
				'parent'      => $panel_text
			)
		);
		
		$row_res_text_2 = vakker_eltd_add_admin_row(
			array(
				'name'   => 'row_res_text_2',
		...
		$group_link = vakker_eltd_add_admin_group(
			array(
				'name'        => 'group_link',
				'title'       => esc_html__( 'Links', 'vakker' ),
				'description' => esc_html__( 'Define styles for link text', 'vakker' ),
				'parent'      => $panel_text
			)
		);
		
		$row_link_1 = vakker_eltd_add_admin_row(
			array(
				'name'   => 'row_link_1',
				'parent' => $group_link
			)
		...
		vakker_eltd_add_admin_field(
			array(
				...
				'name'          => 'link_color',
				'default_value' => '',
				'label'         => esc_html__( 'Link Color', 'vakker' ),
				'parent'        => $row_link_1
			)
		);
		...
		vakker_eltd_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hover Link Color', 'vakker' ),
				'parent'        => $row_link_1
			)
		);
		
		$row_link_2 = vakker_eltd_add_admin_row(
			array(
				'name'   => 'row_link_2',
				'parent' => $group_link,
				'next'   => true
		...
		vakker_eltd_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Link Decoration', 'vakker' ),
				'options'       => vakker_eltd_get_text_decorations(),
				'parent'        => $row_link_2
			)
		);
		...
		vakker_eltd_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hovel Link Decoration', 'vakker' ),
				'options'       => vakker_eltd_get_text_decorations(),
				'parent'        => $row_link_2
			)
		);
	...
	add_action( 'vakker_eltd_options_map', 'vakker_eltd_fonts_options_map', 10 );
}