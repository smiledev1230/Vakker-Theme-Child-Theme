...
if ( ! function_exists('vakker_eltd_contact_form_7_options_map') ) {

	function vakker_eltd_contact_form_7_options_map() {

		vakker_eltd_add_admin_page(array(
			'slug'	=> '_contact_form7_page',
			'title'	=> esc_html__('Contact Form 7', 'vakker'),
			'icon'	=> 'fa fa-envelope-o'
		));

		$panel_contact_form_style_1 = vakker_eltd_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_1',
			'title'	=> esc_html__('Custom Style 1', 'vakker')
		));

		//Text Typography

		$typography_text_group = vakker_eltd_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'vakker'),
			'description'	=> esc_html__('Setup typography for form elements text', 'vakker'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_text_row1 = vakker_eltd_add_admin_row(array(
		...
		vakker_eltd_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Text Color', 'vakker'),
		));
		...
		$typography_text_row2 = vakker_eltd_add_admin_row(array(
		...
		$typography_text_row3 = vakker_eltd_add_admin_row(array(
		...
		$typography_label_group = vakker_eltd_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'vakker'),
			'description'	=> esc_html__('Setup typography for form elements label', 'vakker'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_label_row1 = vakker_eltd_add_admin_row(array(
		...
		$typography_label_row2 = vakker_eltd_add_admin_row(array(
		...
		$background_border_group = vakker_eltd_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'vakker'),
			'description'	=> esc_html__('Setup form elements background and border style', 'vakker'),
			'parent'		=> $panel_contact_form_style_1
		));

		$background_border_row1 = vakker_eltd_add_admin_row(array(
		...
		vakker_eltd_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Color', 'vakker')
		));
		...
		vakker_eltd_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Transparency', 'vakker')
		));

		$background_border_row2 = vakker_eltd_add_admin_row(array(
		...
		vakker_eltd_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Transparency', 'vakker'),
		));
		...
		vakker_eltd_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Color', 'vakker')
		));
		...
		vakker_eltd_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Transparency', 'vakker')
		));

		$background_border_row3 = vakker_eltd_add_admin_row(array(
		...
		vakker_eltd_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Width', 'vakker'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		vakker_eltd_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Radius', 'vakker'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$padding_group = vakker_eltd_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'vakker'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_1
		));

		$padding_row = vakker_eltd_add_admin_row(array(
			'name'		=> 'padding_row',
		...
		vakker_eltd_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Top', 'vakker'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		vakker_eltd_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Right', 'vakker'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		vakker_eltd_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Bottom', 'vakker'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		vakker_eltd_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Left', 'vakker'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$margin_group = vakker_eltd_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'vakker'),
			'description'	=> esc_html__('Setup form elements margin', 'vakker'),
			'parent'		=> $panel_contact_form_style_1
		));

		$margin_row = vakker_eltd_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		vakker_eltd_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Textarea Height', 'vakker'),
			'description'	=> esc_html__('Enter height for textarea form element', 'vakker'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$button_typography_group = vakker_eltd_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'vakker'),
			'description'	=> esc_html__('Setup button text typography', 'vakker'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_typography_row1 = vakker_eltd_add_admin_row(array(
		...
		$button_typography_row2 = vakker_eltd_add_admin_row(array(
		...
		$button_background_border_group = vakker_eltd_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'vakker'),
			'description'	=> esc_html__('Setup button background and border style', 'vakker'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_background_border_row1 = vakker_eltd_add_admin_row(array(
		...
		vakker_eltd_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Color', 'vakker')
		));
		...
		vakker_eltd_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Transparency', 'vakker')
		));

		$button_background_border_row2 = vakker_eltd_add_admin_row(array(
		...
		vakker_eltd_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Color', 'vakker')
		));
		...
		vakker_eltd_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Transparency', 'vakker')
		));

		$button_background_border_row3 = vakker_eltd_add_admin_row(array(
		...
		vakker_eltd_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Height', 'vakker'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		vakker_eltd_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Left/Right Padding', 'vakker'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$panel_contact_form_style_2 = vakker_eltd_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'vakker')
		));
        ...
        $panel_contact_form_style_3 = vakker_eltd_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'vakker')
        ));
        ...
        $typography_label_row3 = vakker_eltd_add_admin_row(array(
        ...
        $button_typography_row3 = vakker_eltd_add_admin_row(array(
	...
	add_action( 'vakker_eltd_options_map', 'vakker_eltd_contact_form_7_options_map', 20);
}