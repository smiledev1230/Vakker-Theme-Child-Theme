...
class VakkerElatedSearchPostType extends VakkerElatedWidget {
	public function __construct() {
		parent::__construct(
			'eltd_search_post_type',
			esc_html__( 'Elated Search Post Type', 'vakker' ),
			array( 'description' => esc_html__( 'Select post type that you want to be searched for', 'vakker' ) )
		);
	...
	public function widget( $args, $instance ) {
		...
		<div class="widget eltd-search-post-type-widget">
			<div data-post-type="<?php echo esc_attr( $post_type ); ?>" <?php vakker_eltd_class_attribute( $search_type_class ); ?>>
				<input class="eltd-post-type-search-field" value="" placeholder="<?php esc_attr_e( 'Search here', 'vakker' ) ?>">
