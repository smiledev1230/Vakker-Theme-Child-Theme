...
if (!class_exists('VakkerElatedFullscreenNavigationWalker')) {
	class VakkerElatedFullscreenNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
				...
				if($args->has_children) {
					$item_output .= '<i class="eltd-fullscreen-menu-arrow fa fa-angle-down"></i>';
				}
				$item_output .= '</a>';
			}
