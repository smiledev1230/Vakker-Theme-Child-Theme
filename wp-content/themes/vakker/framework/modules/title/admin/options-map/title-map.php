...
if ( ! function_exists( 'vakker_eltd_get_title_types_options' ) ) {
	function vakker_eltd_get_title_types_options() {
		$title_type_options = apply_filters( 'vakker_eltd_title_type_global_option', $title_type_options = array() );
		
		return $title_type_options;
	}
}

if ( ! function_exists( 'vakker_eltd_get_title_type_default_options' ) ) {
	function vakker_eltd_get_title_type_default_options() {
		$title_type_option = apply_filters( 'vakker_eltd_default_title_type_global_option', $title_type_option = '' );
...
if ( ! function_exists('vakker_eltd_title_options_map') ) {
	function vakker_eltd_title_options_map() {
		$title_type_options        = vakker_eltd_get_title_types_options();
		$title_type_default_option = vakker_eltd_get_title_type_default_options();
		...
		$panel_title = vakker_eltd_add_admin_panel(
			array(
				'page' => '_title_page',
				'name' => 'panel_title',
				'title' => esc_html__('Title Settings', 'vakker')
			)
		);
		...
		vakker_eltd_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'This option will enable/disable Title Area', 'vakker' ),
				'parent'        => $panel_title,
				'args'          => array(
					'dependence'             => true,
			...
			$show_title_area_container = vakker_eltd_add_admin_container(
				array(
					'parent'          => $panel_title,
				...
				vakker_eltd_add_admin_field(
					...
					vakker_eltd_add_admin_field(
						array(
							...
							'description'   => esc_html__( 'Specify title vertical alignment', 'vakker' ),
							'parent'        => $show_title_area_container,
							'options'       => array(
		...
		do_action( 'vakker_eltd_additional_title_area_options_map', $show_title_area_container );
		
		/***************** Additional Title Area Layout - end *****************/
		
		
		$panel_typography = vakker_eltd_add_admin_panel(
			array(
				'page'  => '_title_page',
			...
			$group_page_title_styles = vakker_eltd_add_admin_group(
				array(
					'name'        => 'group_page_title_styles',
					'title'       => esc_html__( 'Title', 'vakker' ),
					'description' => esc_html__( 'Define styles for page title', 'vakker' ),
					'parent'      => $panel_typography
				)
			);
		
				$row_page_title_styles_1 = vakker_eltd_add_admin_row(
					array(
				...
				$row_page_title_styles_2 = vakker_eltd_add_admin_row(
					array(
				...
				$row_page_title_styles_3 = vakker_eltd_add_admin_row(
					array(
			...
			vakker_eltd_add_admin_section_title(
				array(
					...
					'title'  => esc_html__( 'Subtitle', 'vakker' ),
					'parent' => $panel_typography
				)
			);
		
			$group_page_subtitle_styles = vakker_eltd_add_admin_group(
				array(
					'name'        => 'group_page_subtitle_styles',
					'title'       => esc_html__( 'Subtitle', 'vakker' ),
					'description' => esc_html__( 'Define styles for page subtitle', 'vakker' ),
					'parent'      => $panel_typography
				)
			);
		
				$row_page_subtitle_styles_1 = vakker_eltd_add_admin_row(
					array(
				...
				$row_page_subtitle_styles_2 = vakker_eltd_add_admin_row(
					array(
				...
				$row_page_subtitle_styles_3 = vakker_eltd_add_admin_row(
					array(
		...
		do_action( 'vakker_eltd_additional_title_typography_options_map', $panel_typography );
		
		/***************** Additional Title Typography Layout - end *****************/
    }

	add_action( 'vakker_eltd_options_map', 'vakker_eltd_title_options_map', 4);
}