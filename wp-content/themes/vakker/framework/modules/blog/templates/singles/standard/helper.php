...
if( !function_exists('vakker_eltd_get_blog_single_holder_classes') ) {
    /**
     * Function that generates blog holder classes for single blog page
     */
    function vakker_eltd_get_blog_single_holder_classes($classes) {
    ...
    add_filter( 'vakker_eltd_blog_single_holder_classes', 'vakker_eltd_get_blog_single_holder_classes' );
}
